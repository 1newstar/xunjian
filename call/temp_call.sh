...
echo ''>/tmp/xunjian/sqlfile/$SOURCE_DB_HOSTNAME/temp_tablespace_created_sql.sql


##connect source database and get database data##
sqlplus -S $XUNJIAN_USER/$XUNJIAN_PASSWORD@$ip:$SOURCE_DB_PORT/$SOURCE_DB_INSTANCE  @$INSTALL_PATH/script/temp_tablespace_useage.sql >>/tmp/xunjian/sqlfile/$SOURCE_DB_HOSTNAME/temp_tablespace_created_sql.sql


##execute sql##
sqlplus -S $XUNJIAN_USER/$XUNJIAN_PASSWORD@$TARGET_DB_IP:$TARGET_DB_PORT/$TARGET_DB_INSTANCE @/tmp/xunjian/sqlfile/$SOURCE_DB_HOSTNAME/temp_tablespace_created_sql.sql >>/tmp/xunjian/log/$SOURCE_DB_HOSTNAME/temp_tablespace.log


echo ''
echo "sql script path is  /tmp/xunjian/sqlfile/$SOURCE_DB_HOSTNAME/temp_tablespace_created_sql.sql"
echo "sql script execute log path is  /tmp/xunjian/log/$SOURCE_DB_HOSTNAME/temp_tablespace.log"
